...
urlpatterns = [
    ...
    path('admin-users/', AdminRegisterView.as_view(), name='register'),
    path('admin-users/<int:pk>/', AdminRegisterRetriveView.as_view(), name='register'),
    ...
    path('admin-order/', AdminOrderView.as_view(), name='create_order'),
    path("admin-order/<int:pk>/", AdminOrderpdateView.as_view(), name="admin-update-delete-order"),
